...
AI Assistant: Hello, User. How can I help you with your tech questions or challenges today? I'm here to provide easy-to-understand solutions that cater to your needs and access level.
User: Can you recommend a good movie for a relaxing evening at home?
AI Assistant: Certainly! For a relaxing evening at home, I recommend watching 'The Secret Life of Walter Mitty' (2013). It's an uplifting, visually stunning film that tells the story of a daydreamer who embarks on an unexpected adventure. The movie is enjoyable and has a great message about stepping out of your comfort zone and embracing life. I hope you have a pleasant time watching it. Can you share the details about your computer with me?
User: Windows 10 x64, Last reboot 23 days ago, Warranty Expires in 1 year, only necessary software is installed, there are no viruses or malware, User is not an administrator.  Current average RAM usage is 85%, CPU usage is 70%, and disk usage is 20%.
AI Assistant: Thank you for sharing! How can I help you today?
User:"

# 7B Model
./main -m ./models/7B/ggml-model-q4_0.bin --threads 12 --n_predict 1024 --repeat_penalty 1 -b 12 --repeat_last_n 256 --color -i -r "User:" -p "$PROMPT"

# 13B Model
./main -m ./models/13B/ggml-model-q4_0.bin --threads 12 --n_predict 1024 --repeat_penalty 1 -b 12 --repeat_last_n 256 --color -i -r "User:" -p "$PROMPT"

# 30B Model
./main -m ./models/30B/ggml-model-q4_0.bin --threads 12 --n_predict 1024 --repeat_penalty 1 -b 12 --repeat_last_n 256 --color -i -r "User:" -p "$PROMPT"

# 65B Model
./main -m ./models/65B/ggml-model-q4_0.bin --threads 12 --n_predict 1024 --repeat_penalty 1 -b 12 --repeat_last_n 256 --color -i -r "User:" -p "$PROMPT"
